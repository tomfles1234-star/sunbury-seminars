...
const COLUMN_ALIASES = Object.freeze({
  ...
  Fee: ['Fee', 'fee', 'price'],
  PaymentMethod: ['PaymentMethod', 'paymentMethod', 'payment_method', 'payMethod']
});
...
function personToRow(person, buyer, submittedAt, courseDate) {
  ...
  return {
    ...
    PaymentMethod: pick(p, ['PaymentMethod', 'paymentMethod', 'payment_method'], '') || pick(b, ['PaymentMethod', 'paymentMethod', 'payment_method'], '')
  };
}
